...
const ProjectDescription = ({  description }) =>{
  ...
  return (
    ...
    <div className="project" style={style.project} >
     ...
     {description?.live_demo && <a target='_blank' style={{color:'tomato', marginRight:'1rem'}} title="online demo" href={description?.live_demo}><CgMediaLive style={{fontSize:'3rem'}}/></a>}
  
     {description?.screenshots &&  <a  style={{color:'tomato', 
                marginRight:'1rem',
                cursor:'pointer'
                }} title="screenshots"   onClick={handleShow}><RiScreenshot2Line style={{fontSize:'3rem'}}/></a>}
